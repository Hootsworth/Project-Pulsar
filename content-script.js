    ...
    function showKeyInput() {
        ...
        overlay.innerHTML = `
            <div class="htt-ping-bar htt-key-modal">
                <div class="htt-key-header-wrapper" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                    <div class="htt-key-header" style="font-weight: 600; font-size: 1.1em;">Setup Quick AI</div>
                    <button class="htt-close-red" id="httKeyClose" title="Close"></button>
                </div>
        ...
        overlay.querySelector('#httKeyClose').addEventListener('click', close);
            ...
            setTimeout(() => {
                ...
                responseContent.innerHTML = `
                    ...
                    <div style="position: absolute; top: 20px; right: 20px;">
                        <button id="httAIClose" class="htt-close-red" title="Close Answer"></button>
                    </div>
                `;
